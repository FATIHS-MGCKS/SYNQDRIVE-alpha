...
| **D4** | **D4 architecture COMPLETE ON MAIN** (PR #1751); **D4 Engineering V1 COMPLETE ON MAIN** (PR #1754 @ `9a3e457d9`) — digest / revision / source-evidence integrity inspection; **not evaluated** by D2 |
