...
| Gate | Requires |
|------|----------|
| **Stage-2 LV e2e** | PKG-01 + PKG-02 implemented; PKG-01 **IMPLEMENTATION_READY** (D1/D2/D3); PKG-02 **IMPLEMENTATION_READY** (D4/D5); separate runtime implementation authorization; M4 cutover **not** authorized by D3 |
