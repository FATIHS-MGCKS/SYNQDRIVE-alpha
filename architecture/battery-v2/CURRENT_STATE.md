...
| M3.2B shadow shutdown evidence (`2026-09-07`, PR #1560) | **DEPLOYED flag-off** @ `0ba96e03` release `20260907204434_v4994`; Phase B **PASS** — schema live, 0 shadow writes, authoritative paths unchanged; `BATTERY_V2_SHUTDOWN_EVIDENCE_SHADOW_ENABLED` absent (effective false); see `research/M3_2B_PHASE_B_FLAG_OFF_PRODUCTION_DEPLOY_2026-09-07.md` + `research/M3_2B_SHUTDOWN_EVIDENCE_ACQUISITION_IMPLEMENTATION_2026-09-07.md` |
