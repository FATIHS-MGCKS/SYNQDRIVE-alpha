...
**Snapshot date:** 2026-09-21 (M3.3B R1 cadence forensics + shadow qualification)  
...
| M3.3B R1 natural cadence forensics (`2026-09-21`) | **READ-ONLY PROD FORENSICS COMPLETE**; `REST_CADENCE_POLICY_VERSION=M3_3B_V1`; nominal index + metrics wired; see `research/M3_3B_R1_NATURAL_CADENCE_FORENSICS_2026-09-21.md` |
| `NEXT_PHASE` | **Deploy M3.3A B0** → optional **B1 shadow**; M3.3C REST_STABLE research; wake-load order still **open** |
