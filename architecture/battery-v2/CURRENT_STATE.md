...
**Snapshot date:** 2026-09-26 (M3.3F **F2 production gate PASS** — deploy `2b54a357854c9d44f638ee857f72936967c04992` / release `20260926094359_v4994`; F1 PR #1787; supersedes pre-F2 production `8a1d9c6586cbddc41bb6c94870f9d51226d71aa2`; M3.3E E3 on main PR #1778 @ `55fcbe7a2`; graph validated 2026-09-25)
...
| **M3.3F F2 (production gate)** | Flag-OFF deploy + zero-write smoke + ops `SKIPPED_FLAG_OFF` — **PASS** @ `2026-09-26`; **`M3_3F_F2_PRODUCTION_GATE=PASS`**; **`F3_ALLOWED=YES`**; **`F3_EXECUTED=NO`** — `research/M3_3F_F2_FLAG_OFF_PRODUCTION_DEPLOY_2026-09-26.md` |
| **M3.3C roadmap (planning)** | **M3.3F F2 complete** → **F3 controlled C3 shadow activation** next; **M3.3G–H pending** |
| **M3.3C** | **`OPEN`** — C1–C5B + **M3.3D + M3.3E E0–E0.2 + M3.3E E1 + M3.3E E2 + M3.3E E3 on main**; **M3.3F–H pending**; **`BATTERY_V2_REST_SESSION_FEATURES_SHADOW_ENABLED=false`** |
...
| `NEXT_PHASE` | **M3.3F F3 controlled C3 shadow activation** — **`M3_3F_F0_COMPLETE_ON_MAIN=YES`**; **`M3_3F_F1_COMPLETE_ON_MAIN=YES`**; **`M3_3F_F2_PRODUCTION_GATE=PASS`**; **`C3_PRODUCTION_ACTIVATED=NO`**; **`D3_PRODUCTION_ACTIVATED=NO`**; **`D3_PRODUCTION_WRITES_EFFECTIVELY_GATED_OFF=YES`**; **`M3_3F_REMAINS_PENDING=YES`**; **`PRODUCTION_MATERIALIZATION_READY=NO`**; **`F3_ALLOWED=YES`**; **`F3_EXECUTED=NO`**; **`D3_RUNTIME_REACHABLE=NO`** until flag ON + authorized activation; **`D4_RUNTIME_REACHABLE=NO`**; **`E3_RUNTIME_REACHABLE=NO`**; M3.3G / M3.3H **pending** |
