...
| `M3_3_B1_STATUS` | **`B1_ACTIVATION_RUNTIME_PASS`** — natural evidence **OBSERVED** (n=1 `DRIVING_NON_CHARGING`); rest-session ladder **PENDING** — `research/M3_3_B1_GENERALIZED_EVIDENCE_SHADOW_ACTIVATION_2026-09-21.md` |
