...
| `NEXT_PHASE` | **M3.3D D4 Integrity / Inspection** — digest/revision/source-evidence integrity + bounded inspection surfaces; **not** production D3 materialization (M3.3F remains later); M3.3E / M3.3F / M3.3G / M3.3H **pending** |
