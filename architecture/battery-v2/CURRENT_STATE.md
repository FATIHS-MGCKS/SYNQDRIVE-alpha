...
| **M3.3E E1 (engineering)** | Pure `buildLongitudinalAssessmentInputV1` adapter — **ENGINEERING ON DRAFT PR #1765** (not complete until merge); **`M3_3E_HEALTH_MODEL_IMPLEMENTED=NO`** — `research/M3_3E_E1_LONGITUDINAL_ASSESSMENT_INPUT_ADAPTER_2026-09-25.md` |
| **M3.3C roadmap (planning)** | **M3.3E E1** draft engineering → **M3.3F–H** pending |
| **M3.3C** | **`OPEN`** — C1–C5B + **M3.3D + M3.3E E0–E0.2 on main**; **M3.3E E1 engineering draft PR #1765**; **M3.3F–H pending**; **`BATTERY_V2_REST_SESSION_FEATURES_SHADOW_ENABLED=false`** |
