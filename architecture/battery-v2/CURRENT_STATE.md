...
| `M3_3_B1_2R_STATUS` | **`B1_2R_SIGNAL_OBSERVABILITY_NO_TRUSTWORTHY_SHUTDOWN_LV`** @ `2026-09-21T19:22:04Z` — trip `db0039e8…` ended `18:47:47Z`; operator park ~18:48–18:58Z; **last LV `18:47:56Z` only** (`engineRunning=true`, LV charging); **0** post-park LV — `research/M3_3_B1_2R_WOB_L7503_NATURAL_SHUTDOWN_FORENSICS_2026-09-21.md` |
