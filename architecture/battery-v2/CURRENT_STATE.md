...
**Snapshot date:** 2026-09-24 (M3.3C C1–C5B + M3.3D D0/D0.1/D1/D2/D3 architecture on main; D3 merge PR #1744 @ `7919bdd5c`; D2 merge PR #1739 @ `ed7adb79b`; D1 merge PR #1737 @ `9577e0f14`; production runtime baseline unchanged `2b0ef15f`)
...
| **M3.3D D3 foundation** | Prisma `BatteryLongitudinalProfileRevision` + migration + internal idempotent materialization stack — **ENGINEERING ON DRAFT PR** (not complete on main); **`D3_RUNTIME_REACHABLE=NO`**; **`PRODUCTION_MATERIALIZATION_READY=NO`** until **M3.3F** — `research/M3_3D_D3_FOUNDATION_ENGINEERING_2026-09-24.md` |
