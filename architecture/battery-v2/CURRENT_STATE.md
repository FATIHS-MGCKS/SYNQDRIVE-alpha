...
| **M3.3D D4 (architecture)** | Longitudinal integrity / inspection architecture audit — **ARCHITECTURE AUDIT ON DRAFT PR** (see `research/M3_3D_D4_LONGITUDINAL_INTEGRITY_INSPECTION_ARCHITECTURE_2026-09-24.md`); **not implemented** |
