...
- **Global BullMQ job-id hardening (2026-08-26):** All non-connectivity producers migrated to `sanitizeBullMqJobId()` — see `architecture/BULLMQ_JOB_ID_COMPATIBILITY_2026-08.md`.
