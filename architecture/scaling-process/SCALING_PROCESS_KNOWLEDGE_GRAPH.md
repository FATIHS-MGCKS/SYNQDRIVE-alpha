...
│   ├── Trip reconciliation duplicate rows → INC-07 (P1.8.3.3 forensic) — **FIX_DEPLOYED_PRODUCTION_VALIDATION_IN_PROGRESS** (P1.8.3.6.1 extension MODERATE: 3 warm cycles, 1 gap-split APPLIED, 0 replay)
