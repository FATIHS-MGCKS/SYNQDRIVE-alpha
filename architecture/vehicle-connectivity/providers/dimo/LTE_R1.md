...
- `providerFetchedAt` vs `sourceTimestamp` semantics (see VC-INV-001)
- Native DIMO webhooks vs scheduler polls
- `obdIsPluggedIn` as physical evidence
- Low-voltage battery and GNSS on standby wakes
- Ruptela IO174 sleep timer (not visible in signalsLatest — VC-HYP-002)
