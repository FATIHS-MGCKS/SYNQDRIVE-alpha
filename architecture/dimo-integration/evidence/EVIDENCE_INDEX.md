...
**Production release (current):** `8a1d9c6586cbddc41bb6c94870f9d51226d71aa2` @ `/opt/synqdrive/releases/20260925182907_v4994` (TDL-OQ-009 read-only @ `2026-09-26`)
**Production release (historical R9 canary):** `0ba96e03fc2f1551db79d2dae151c928a9fd936a` @ `/opt/synqdrive/releases/20260907204434_v4994`
...
| DIM-EV-PROD-R9-001 | PRODUCTION_OBSERVATION | Deployed build grep @ `0ba96e03…` | **R9 SnapshotWakeIntakeService present** in webhook controller | CONFIRMED_AT_PRODUCTION_RELEASE | Superseded for **current** Production by ancestry @ `8a1d9c658…`; natural R9 **start** wake observed historically |
...
| DIM-EV-R9-CANARY-001 | PRODUCTION_OBSERVATION | Authorized five-vehicle R9 canary + GET audit | Provider wiring **PASS** — 5/5 speed+ignition; stableIds `9eeb7158afee`, `5d611d470eab` | CONFIRMED_AT_PRODUCTION_RELEASE @ `0ba96e03…` | Authorized cohort **5**; re-read **100%** @ `8a1d9c658…` (TDL-EVID-OQ009-R9-INGRESS-001); historical artifact retains excluded asset id |
| DIM-EVID-OQ009-CROSS-001 | PRODUCTION_OBSERVATION cross-ref | [../trip-detection-lifecycle/evidence/TDL_OQ_009_TIERED_POLLING_R9_INGRESS_2026-09-26.md](../trip-detection-lifecycle/evidence/TDL_OQ_009_TIERED_POLLING_R9_INGRESS_2026-09-26.md) | R9 authorized cohort coverage + scheduler DB mirror separation @ `8a1d9c658…` | CONFIRMED @ `2026-09-26` | Read-only; no provider mutation |
...
| DIM-EV-WEBHOOK-OPS-001 | OPERATIONS_RUNBOOK | [operations/WEBHOOK_OPERATIONS.md](../operations/WEBHOOK_OPERATIONS.md) | Verified DIMO Vehicle Triggers API workflows (auth, list, create, subscribe, PUT update, rollback); UNPLUG recovery PUT executed 2026-09-12 | CONFIRMED | Cross-ref VDC-EVID-GT-R1-UNPLUG-RECOVERY-001 |
| DIM-EVID-OQ006-BOUNDARY-001 | PRODUCTION_OBSERVATION | [../trip-detection-lifecycle/evidence/TDL_OQ_006_DIMO_SEGMENT_FSM_BOUNDARY_AUDIT_2026-09-25.md](../trip-detection-lifecycle/evidence/TDL_OQ_006_DIMO_SEGMENT_FSM_BOUNDARY_AUDIT_2026-09-25.md) | DIM-GAP-001 / segment vs FSM boundary ownership | CONFIRMED @ `99d722b4…` audit window | Cross-ref TDL-EVID-OQ006-BOUNDARY-001 |
