...
| 2026-09-26 | TDL-OQ-009 cross-authority sync — current Production @ `8a1d9c658…`; R9 authorized cohort 100%; natural start wake wording; stale former-fleet mirror (DIM-GAP-005) | Docs-only (PR #1789) | [../trip-detection-lifecycle/evidence/TDL_OQ_009_TIERED_POLLING_R9_INGRESS_2026-09-26.md](../trip-detection-lifecycle/evidence/TDL_OQ_009_TIERED_POLLING_R9_INGRESS_2026-09-26.md) |
| 2026-09-26 | Dormant DI consumer registered for review — DI V0 S3A adapter calls `DimoAuthService.getVehicleJwt` + `DimoTelemetryService.queryGraphQL` with full `buildDimoProviderRequestContext`; call-site audit `FULL_CONTEXT_REQUIRED`; **no DIMO Integration code change**, no runtime caller, no live call | EXP-021 C1D.7 (DI-owned) | [../../drivingintelligence/evidence/EXP021_C1D7_S3A_INPUT_NORMALIZATION_REPORT.md](../../drivingintelligence/evidence/EXP021_C1D7_S3A_INPUT_NORMALIZATION_REPORT.md) |
