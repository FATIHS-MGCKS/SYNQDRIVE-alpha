...
**Last updated:** 2026-09-11 (Vehicle Connectivity authority bootstrap — `AUDIT_IN_PROGRESS`)
...
| Vehicle Connectivity | Provider-neutral connectivity lifecycle, hardware/provider freshness, standby/disconnect/reconnect semantics, and connectivity-state projection. | `AUDIT_IN_PROGRESS` | Bootstrap audit · current-state reconstruction in progress | [`architecture/vehicle-connectivity/`](vehicle-connectivity/) |
