...
| EED-EV-0044 | CODE+TEST | RFRF F3 raw rise detector 2026-09-12 | `eed-rfrf-f3-raw-rise-detector-2026-09-12.md` | STABLE_PRE→RISING→STABLE_POST FSM; F3.1 plateau invariant, single-step, coalescence, local post, wobble fail-closed; KS MS 661 fixtures; 50 unit tests; 4 F2 handoff PG proofs | F4 runtime wiring | PROVEN_BY_INTEGRATION_TEST | 2026-09-12 |
