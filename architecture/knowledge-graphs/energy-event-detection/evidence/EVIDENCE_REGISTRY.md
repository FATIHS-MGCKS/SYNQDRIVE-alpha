...
| EED-EV-0043 | CODE+TEST | RFRF F2 + F2.1 candidate persistence 2026-09-12 | `eed-rfrf-f2-candidate-persistence-2026-09-12.md` | `raw_refuel_candidates` schema+migration; service-owned clocks; org/vehicle integrity; nullable identity key; terminal rediscovery; merged fingerprint; 18 unit + 17 real-PG integration tests PASS | F3 detector | PROVEN_BY_INTEGRATION_TEST | 2026-09-12 |
