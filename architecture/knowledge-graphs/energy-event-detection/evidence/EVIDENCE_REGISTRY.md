...
| EED-EV-0053 | CODE+TEST | RFRF runtime Nest DI boot blocker 2026-09-14 | `raw-fuel-refuel-fallback-runtime.di.spec.ts`, deploy boot-check log | Function-typed config loader removed from Nest injectable ctor; `SYNQDRIVE_BOOT_CHECK=1` PASS; RFRF flags/semantics unchanged; prod deploy abort root cause closed | Postgres RFRF gates re-run on CI | PROVEN_BY_TEST | 2026-09-14 |
