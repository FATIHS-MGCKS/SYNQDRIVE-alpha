...
| EED-EV-0043 | CODE+TEST | RFRF F2 candidate persistence 2026-09-12 | `eed-rfrf-f2-candidate-persistence-2026-09-12.md` | `raw_refuel_candidates` schema+migration; semantic rediscovery; pg_advisory_xact_lock64 per vehicle; promotion design only; idempotency matrix A–L partial (opt-in Postgres integration) | F3 detector | PROVEN_BY_UNIT_TEST | 2026-09-12 |
