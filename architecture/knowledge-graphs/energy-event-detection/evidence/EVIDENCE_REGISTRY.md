...
| EED-EV-0045 | DESIGN | RFRF F4 scope + runtime boundary 2026-09-13 | `eed-rfrf-f4-scope-and-runtime-boundary-2026-09-13.md` | F4 Option B phase boundary; detectEnergyEvents parallel path; capability gate case 22; promotion service dark-only; F5 convergence gate before VEE execution; duplicate safety matrix; no runtime code | F4 implementation | PROPOSED | 2026-09-13 |
