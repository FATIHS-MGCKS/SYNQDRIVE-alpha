...
| EED-EV-0060 | CODE+TEST | RFRF F7 recovery completeness 2026-09-15 | `eed-rfrf-f7-recovery-completeness-2026-09-15.md` | Canonical scheduler ownership proven (G2.1a); orphan_refuel closes post-commit crash window; scheduler tick error isolation; real PG F7-P1..P12 + P10 lifecycle (18/18); no second recovery stack; F5-PR3 P17 regression for BullMQ; candidate-level retry out of scope | F8 observability | PROVEN_BY_INTEGRATION_TEST | 2026-09-15 |
