...
| EED-EV-0041 | DESIGN | RFRF F1 architecture 2026-09-12 | `eed-rfrf-f1-architecture-2026-09-12.md` | Raw-fuel fallback contract; Option C identity; STABLE_PRE→RISING→STABLE_POST; G2 handoff; fail-closed | Production rollout | PROPOSED | 2026-09-12 |
