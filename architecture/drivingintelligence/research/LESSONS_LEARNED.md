...
|----|--------|----------|-----------------|
| LL-001 | **Requested aggregation interval ≠ physical sampling rate.** DIMO `interval:"1s"` returns median ~2s bucket spacing. | DI-EV-0026, DI-EV-0034E | DI-INV-POLL-NOT-GEN-001 |
...
| LL-015 | **CODE_DEPLOYED ≠ FEATURE_ENABLED ≠ LIVE_CANARY_EXECUTED.** PR #1533 merged code with all experimental flags default OFF. | PR #1533, C.1e flags | — |
