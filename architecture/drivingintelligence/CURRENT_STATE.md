...
| **LIVE_MULTI_CADENCE_CALIBRATION** | **EXP-019 EXECUTED (2026-09-07)** — KS MX 2024 N=1; **NO cadence winner**; video GT pending |
...
- Live 10/20/30/60s HF calibration — **EXP-019 N=1 complete**; additional drives + settlement replay + video GT required
