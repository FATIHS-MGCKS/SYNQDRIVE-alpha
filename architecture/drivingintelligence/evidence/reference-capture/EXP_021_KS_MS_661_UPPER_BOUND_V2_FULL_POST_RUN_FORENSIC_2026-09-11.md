...
**RUNTIME_FIX_PR = #1606** — merged at `e99cf710088732069bc5d448ae5436b893b3440e` (false physical-end authority hardening).

Evidence-only registration PR — corrected interpretive layer; raw PDI record preserved. Supersedes obsolete evidence PR **#1605** (must not merge).
