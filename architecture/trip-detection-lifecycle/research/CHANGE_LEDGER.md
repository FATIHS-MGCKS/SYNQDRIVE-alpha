...
| 2026-09-09 | R12 pre-hardening Production deploy @ `157b3c722268…` release `20260909190912_v4994`; tree-equivalent CI admission run 34387586390; rolling two-replica ~14s mixed window; T0 KS MS 661 **PHYSICAL_TEST_READY=NO** (ACTIVE_TRIP) — **pre-dates #1594 hardening** | Trip FSM R12 production deploy (authorized) | [R12_PRODUCTION_DEPLOY_2026-09-09.md](../evidence/R12_PRODUCTION_DEPLOY_2026-09-09.md) |
