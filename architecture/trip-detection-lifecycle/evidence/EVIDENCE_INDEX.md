...
| TDL-EVID-R12-KS661-POST-1603-CUSUM-001 | PRODUCTION_OBSERVATION + CODE | [KS_MS_661_R12_POST_1603_CUSUM_RETRY_FAILURE_2026-09-12.md](KS_MS_661_R12_POST_1603_CUSUM_RETRY_FAILURE_2026-09-12.md) | `2026-09-12T05:31:00Z` | Deploy `f6f5eaa3a…`; trip `a05fa903…` | CUSUM reopen strips `stopBoundaryAt` → empty-core stale VLS KEEP_OPEN → no attempts 2–3; root cause **PROVEN** | **FAIL_PENDING_FIX** | Read-only; fix design only |
