...
| TDL-EVID-R12-KS661-ACCEPT-FAIL-001 | PRODUCTION_OBSERVATION + CODE | [KS_MS_661_R12_PHYSICAL_ACCEPTANCE_FAILURE_2026-09-10.md](KS_MS_661_R12_PHYSICAL_ACCEPTANCE_FAILURE_2026-09-10.md) | `2026-09-10T22:00:00Z` | Production `2f1b4f53…`; fix PR #1600 | KS MS 661 stuck POSSIBLE_END — lock contention + NULL PE columns; #1600 family arbitration + clock durability | **OPEN** | Trip not repaired; superseded as acceptance gate by TDL-EVID-R12-KS661-ACCEPT-2026-09-11-001 |
| TDL-EVID-R12-KS661-ACCEPT-2026-09-11-001 | PRODUCTION_OBSERVATION (read-only) | [KS_MS_661_R12_PHYSICAL_ACCEPTANCE_2026-09-11.md](KS_MS_661_R12_PHYSICAL_ACCEPTANCE_2026-09-11.md) | `2026-09-11T05:36:35Z` | Deployed `51394e16…` @ `20260911023450_v4994` PR #1600 | First post-#1600 KS MS 661 drive `fc93f98f…` — **PE clocks durable (PASS partial)**; **END_VALIDATION never ran (FAIL)**; trip stuck POSSIBLE_END/ONGOING | **CONFIRMED_AT_PRODUCTION_RELEASE** | R12 lock contention not reproduced; new EV dispatch gap |
