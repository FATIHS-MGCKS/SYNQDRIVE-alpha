...
| TDL-TEST-R12-PEC-EV-001 | CURRENT_TEST | [trip-r12-pec-ev-lock-collision.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-pec-ev-lock-collision.postgres-redis.integration.spec.ts) | `2026-09-11T12:00:00Z` | fix branch | Lock-order + concurrent BullMQ completion chain + EV lock-miss moveToDelayed | **CI_PENDING** (failed run 34602066031 — fixture stale delayed PEC; corrected in PR #1603 follow-up) | via `test:trip-r12:postgres-redis:ci` |
| TDL-TEST-R12-PEC-EV-002 | CURRENT_TEST | [trip-r12-end-cycle-lock-contention.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-end-cycle-lock-contention.spec.ts) | `2026-09-11T12:00:00Z` | fix branch | EV lock miss → `TripTrackingHandoffLockContentionError` | CONFIRMED_CI | via `test:trip-r12:hardening` |
