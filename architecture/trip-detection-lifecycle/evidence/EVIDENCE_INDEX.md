...
| TDL-EVID-R12-WOB7503-POST-1627-001 | PRODUCTION_OBSERVATION | [WOB_L_7503_POST_1627_PHYSICAL_ACCEPTANCE_2026-09-13.md](WOB_L_7503_POST_1627_PHYSICAL_ACCEPTANCE_2026-09-13.md) | `2026-09-13T10:44:09Z` (corrected ground truth PR #1634) | Deploy `9a32685d…` @ `20260913074250_v4994`; trips `6c88e275…` + `aaedd4a5…` | Two physical drives; #1627 **NOT_EXERCISED**; Trip 2 **FAIL** end-candidate admission (upstream); false-split claim **withdrawn** | **NOT_EXERCISED** (#1627) / **FAIL** (Trip 2 completion) | Initial single-drive assumption superseded; preserved in artifact |
| TDL-EV-R12-PROD-DEPLOY-002 | PRODUCTION_DEPLOY_AUDIT | [WOB_L_7503_POST_1627_PHYSICAL_ACCEPTANCE_2026-09-13.md](WOB_L_7503_POST_1627_PHYSICAL_ACCEPTANCE_2026-09-13.md) § Phase 0 | `2026-09-13T07:54:11Z` | Deployed `9a32685d529bcc55e7163a8f0903ebdec358ebaf` @ `20260913074250_v4994` | #1627 merged + deployed; both replicas same SHA; health confirmed pre-drive | **CONFIRMED_AT_PRODUCTION_RELEASE** | Deploy only — POST-#1627 behavior **FAIL** on first drive |
