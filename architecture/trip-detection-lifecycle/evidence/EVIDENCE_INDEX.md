...
| TDL-EVID-R12-WOB7503-RETRY-BUDGET-001 | PRODUCTION_OBSERVATION + CODE + TEST | [WOB_L_7503_R12_RETRY_BUDGET_FIX_2026-09-12.md](WOB_L_7503_R12_RETRY_BUDGET_FIX_2026-09-12.md) | `2026-09-12T21:00:00Z` | BASE `7cb184ff…`; fix branch | Minimal CUSUM-only retry-budget preservation; BASE/HEAD deterministic proof | **CI_PENDING** (fix not deployed) | CUSUM semantics + false split remain open |
| TDL-TEST-R12-RETRY-BUDGET-001 | CURRENT_TEST | [trip-r12-cusum-retry-budget.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-cusum-retry-budget.postgres-redis.integration.spec.ts) | `2026-09-12` | fix branch | Always-ongoing CUSUM lifecycle BASE RED / HEAD GREEN | **PENDING_CI** | via `test:trip-r12:cusum-retry-budget:base-head-red-proof` |
| TDL-TEST-R12-RETRY-BUDGET-002 | CURRENT_TEST | [trip-end-cycle-reset.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-end-cycle-reset.spec.ts) | `2026-09-12` | fix branch | Unit: CUSUM preserve vs ACTIVITY/movement reset | **PENDING_CI** | via `test:trip-r12:hardening` |
