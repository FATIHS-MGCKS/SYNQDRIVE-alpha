...
| TDL-TEST-R12-PEC-EV-003 | CURRENT_TEST | [trip-r12-pec-ev-base-head-red-probe.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-pec-ev-base-head-red-probe.postgres-redis.integration.spec.ts) | `2026-09-11T16:55:00Z` | portable probe + `test:trip-r11:postgres-redis:ci` | BASE-compatible probe; JSON metrics file; wired into postgres+redis CI | **CI_PENDING** | via `test:trip-r12:pec-ev:base-head-red-proof` |
