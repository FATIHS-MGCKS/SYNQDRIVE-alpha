...
| TDL-EVID-R12-WOB7503-RETRY-BUDGET-001 | PRODUCTION_OBSERVATION + CODE + TEST | [WOB_L_7503_R12_RETRY_BUDGET_FIX_2026-09-12.md](WOB_L_7503_R12_RETRY_BUDGET_FIX_2026-09-12.md) | `2026-09-13T05:54:00Z` | BASE `ca16ca034…`; post-sync HEAD pending CI | Minimal CUSUM-only retry-budget preservation; BASE/HEAD deterministic proof | **CI_PENDING** (fix not deployed) | CUSUM semantics + false split remain open |
| TDL-TEST-R12-RETRY-BUDGET-001 | CURRENT_TEST | [trip-r12-cusum-retry-budget.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-cusum-retry-budget.postgres-redis.integration.spec.ts) | `2026-09-13` | CI pending post-sync | Always-ongoing CUSUM lifecycle BASE RED / HEAD GREEN | **CI_PENDING** | via `test:trip-r12:cusum-retry-budget:base-head-red-proof` |
