...
| TDL-TEST-R12-PEC-EV-001 | CURRENT_TEST | [trip-r12-pec-ev-lock-collision.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-pec-ev-lock-collision.postgres-redis.integration.spec.ts) | `2026-09-11T12:00:00Z` | fix branch | Lock-order + concurrent BullMQ completion chain | CONFIRMED_CI | via `test:trip-r12:postgres-redis:ci` |
