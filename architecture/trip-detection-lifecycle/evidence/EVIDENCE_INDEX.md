...
| TDL-EVID-R12-HARDENING-001 | CURRENT_CODE + CURRENT_TEST | [TDL-DEC-R12-PRE-DRIVE-HARDENING_2026-09-09.md](TDL-DEC-R12-PRE-DRIVE-HARDENING_2026-09-09.md) | `2026-09-09T23:30:00Z` | PR #1594 branch | R12 pre-drive fail-closed continuity + evidence ordering + ignition-ON keep-open + finalize resume case E | **PENDING_CI** | Not deployed; CI status updated after Trip FSM Production Readiness green |
| TDL-TEST-R12-HARDENING-001 | CURRENT_TEST | [trip-decision.engine.continuity.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/decision/trip-decision.engine.continuity.spec.ts) | `2026-09-09T23:30:00Z` | PR #1594 branch | AUD-003 fail-closed + legacy-field regression | PENDING_CI | via `test:trip-r11:unit` |
| TDL-TEST-R12-HARDENING-002 | CURRENT_TEST | [trip-finalize-end-cycle.postgres.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-finalize-end-cycle.postgres.integration.spec.ts) | `2026-09-09T23:30:00Z` | PR #1594 branch | AUD-007 scenario E resume-before-finalize | PENDING_CI | via `test:trip-finalize:postgres:ci` |
