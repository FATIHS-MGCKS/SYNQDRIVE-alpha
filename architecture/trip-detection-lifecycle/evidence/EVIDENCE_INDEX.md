...
| TDL-TEST-R12-PEC-EV-001 | CURRENT_TEST | [trip-r12-pec-ev-lock-collision.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-pec-ev-lock-collision.postgres-redis.integration.spec.ts) | `2026-09-11T12:00:00Z` | fix branch | Lock-order + natural completion chain + EV/FINALIZE natural lock-miss retry | **CI_PENDING** (prior CONFIRMED_CI @ run 34614522784 used manual promote) | via `test:trip-r12:postgres-redis:ci` + 10× repeat |
...
| TDL-TEST-R12-PEC-EV-003 | CURRENT_TEST | [trip-r12-pec-ev-base-head-red-probe.postgres-redis.integration.spec.ts](../../../backend/src/modules/vehicle-intelligence/trips/trip-r12-pec-ev-base-head-red-probe.postgres-redis.integration.spec.ts) | `2026-09-11T15:45:00Z` | fix branch | Portable BASE/HEAD behavioral probe | **CI_PENDING** | via `trip-r12-pec-ev-base-head-red-proof.sh` |
