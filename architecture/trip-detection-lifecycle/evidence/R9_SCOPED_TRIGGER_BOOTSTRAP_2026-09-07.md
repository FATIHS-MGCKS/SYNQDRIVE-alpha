...
Trip Detection cannot claim R9 provider-wake latency benefit until DIMO Integration completes a successful scoped bootstrap and **NATURAL_R9_WAKE_OBSERVATION** validates delivery.
