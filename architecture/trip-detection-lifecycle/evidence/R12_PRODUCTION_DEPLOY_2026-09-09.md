...
> **Authority context (migrated from PR #1592 — historical artifact; observations unchanged):**
>
> | Axis | Value |
> |------|-------|
> | **Artifact scope** | **PRE_HARDENING_R12_PRODUCTION_DEPLOY** — documents the authorized deploy of R12 base code **before** PR #1594 pre-drive hardening |
> | **DEPLOYED_SHA (this artifact)** | `157b3c72226869e4e35d1a9398b78cab50d3fa54` @ `/opt/synqdrive/releases/20260909190912_v4994` |
> | **R12_HARDENED_CODE_ON_MAIN (#1594 merged)** | `f4109e34c24f1eb497e2023f4b4bb997abfc159f` — **CI_VALIDATED** on main; **NOT** proven deployed by this artifact |
> | **R12_HARDENED_PRODUCTION_DEPLOYED** | **NOT YET CONFIRMED** — requires independent post-`f4109e34` deploy evidence |
> | **R12_HARDENED_PRODUCTION_BEHAVIOR_VALIDATED** | **NOT YET CONFIRMED** — requires natural-drive acceptance on hardened production SHA |
>
> This file proves the **earlier** R12 production promotion only. It does **not** prove #1594 hardened code deployment or hardened production behavior.
...
- **NOT** deployment of PR #1594 hardened code @ `f4109e34…` — that merge post-dates this deploy
- **NOT** proof of #1594 pre-drive hardening (AUD-002/003/004/007) on Production
...
2. Trip start under **R12_HARDENED_PRODUCTION_DEPLOYED** code (post-`f4109e34` deploy — not this artifact's SHA alone)
