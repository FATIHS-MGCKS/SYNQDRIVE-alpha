...
- PR #1617 CUSUM boundary preservation — **MERGED** @ `b8663ba8…`; **DEPLOYED** @ `a8320f2ca…` (`20260912194023_v4994`, `2026-09-12T19:40:23Z`); **preserve/re-entry mechanics PRODUCTION_PROVEN** on WOB L 7503; **terminal acceptance FAIL** (13× `cusum_still_ongoing`, no FINALIZE); R12 **not closed**
