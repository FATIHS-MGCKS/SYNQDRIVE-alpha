...
- PR #1603 PEC→EV lock-order fix — **MERGED** @ `9e3a5a19c`; **DEPLOYED** @ `f6f5eaa3a…` (`20260911234818_v4994`, `2026-09-11T23:58:46Z`); **#1603 failure class NOT reproduced** on KS MS 661 drive `a05fa903…`; **CUSUM boundary-durability defect** proven + **fix in PR #1617** (CUSUM-only `ActiveReopenReason` preservation); Production **FAIL_PENDING_FIX** unrepaired
