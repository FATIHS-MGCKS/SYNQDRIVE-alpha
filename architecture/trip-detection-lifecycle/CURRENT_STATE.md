...
- TDL-DEC-R12-001 — **CI_VALIDATED** on PR #1591 @ `091c478af…` (run 34360964547); clock-authority hardening pending final head; first head `f92cd1ff…` failed run 34354237230; **not deployed**
