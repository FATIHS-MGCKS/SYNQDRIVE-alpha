...
- PR #1627 retry-budget preservation — **MERGED + DEPLOYED** @ `9a32685d…`; **NOT_EXERCISED** on WOB POST-#1627 drives; root-cause forensics (PR #1634): **POST_MOVEMENT_TELEMETRY_SILENCE_DEAD_ZONE** — stale VLS + no trusted boundary after movement retirement → perpetual `vls_stale_provider_observation` KEEP_OPEN; same class as KS MS 661 R11; gap-split accidental recovery on Trip 1 **PROVEN**
