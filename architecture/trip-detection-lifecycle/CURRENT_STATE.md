...
- PR #1603 PEC→EV lock-order fix — **MERGED** @ `9e3a5a19c`; **DEPLOYED** @ `f6f5eaa3a…` (`20260911234818_v4994`, `2026-09-11T23:58:46Z`); **#1603 failure class NOT reproduced** on first POST-#1603 KS MS 661 drive `a05fa903…`; **new POST-#1603 defect** — CUSUM reopen strips trusted `stopBoundaryAt` → empty-core stale VLS block → no CUSUM attempts 2–3 → **FAIL_PENDING_FIX** (TDL-EVID-R12-KS661-POST-1603-CUSUM-001 @ `2026-09-12T05:31:00Z`)
