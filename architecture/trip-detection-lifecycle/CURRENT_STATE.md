...
- Production validation of R9 adaptive polling wake — **runtime deployed** @ `0ba96e03…`; **provider speed/ignition trigger coverage absent** (scoped bootstrap ROLLED_BACK; see TDL-EV-R9-BOOTSTRAP-001)
- Natural R9 wake delivery — **not observed** (NEXT_GATE: NATURAL_R9_WAKE_OBSERVATION)
