...
- PR #1603 PEC→EV lock-order fix — **MERGED** @ `9e3a5a19c`; **DEPLOYED** @ `f6f5eaa3a…` (`20260911234818_v4994`, `2026-09-11T23:58:46Z`); **#1603 failure class NOT reproduced** on KS MS 661 drive `a05fa903…` or WOB L 7503 drive `4083e24c…` (TDL-EVID-R12-WOB7503-POST-1617-001)
- PR #1617 CUSUM boundary preservation — **MERGED** @ `b8663ba8…`; **DEPLOYED** @ `a8320f2ca…` (`20260912194023_v4994`, `2026-09-12T19:40:23Z`); **preserve/re-entry mechanics PRODUCTION_PROVEN** on WOB L 7503; **terminal acceptance FAIL** — root cause **PROVEN**: `END_VALIDATION_RETRY_BUDGET_RESET_LOOP` (CUSUM ongoing resets `endValidationAttempts` → max-attempt fallback unreachable); secondary CUSUM tail semantics; separate false-split track at drive start; R12 **not closed**
