...
- TDL-DEC-R12-001 — **IMPLEMENTED_AWAITING_CI** on PR #1591; first head `f92cd1ff…` failed CI run 34354237230; remediation pushed locally — **awaiting green CI on final head**; **not deployed**
