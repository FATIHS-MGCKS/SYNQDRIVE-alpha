...
- PR #1627 retry-budget preservation — **MERGED + DEPLOYED** @ `9a32685d…` (`20260913074250_v4994`, TDL-EV-R12-PROD-DEPLOY-002); **CI_VALIDATED**; POST-#1627 WOB L 7503 acceptance (TDL-EVID-R12-WOB7503-POST-1627-001): **#1627 NOT_EXERCISED** (0× EV); Trip 2 **FAIL** end-candidate admission upstream; operator correction (PR #1634) — **two physical drives**; false-split claim **withdrawn**; initial single-drive audit superseded in artifact
