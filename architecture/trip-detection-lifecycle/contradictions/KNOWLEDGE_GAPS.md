...
| **TDL-GAP-016** | Tiered polling vs R9 provider-wake ingress contract | **RESOLVED** | TDL-EVID-OQ009-R9-INGRESS-001 — shared canonical queue; tier fallback; **5/6** speed+ignition subscription coverage |
