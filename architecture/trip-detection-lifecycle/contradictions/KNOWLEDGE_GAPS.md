...
| **TDL-GAP-013** | Natural R9 webhook wake end-to-end delivery | **PARTIAL** | Start wake observed KS MS 661 @ `684950419…` (TDL-EV-KS-MS-661-001); efficiency + payload archive gaps remain — cross-ref DIM-GAP-006 |
| **TDL-GAP-014** | Empty-core `no_core_data_keep_open` end block on natural LTE drive | **OPEN** | KS MS 661 — stale VLS ACTIVE blocked `POSSIBLE_END`; 139 phased runs; trip ONGOING @ addendum (TDL-EV-KS-MS-661-001) |
