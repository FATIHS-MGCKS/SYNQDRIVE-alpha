...
|--------|-------|-----------|-------|
| **TDL-GAP-001** | COMPLETED → Driving Intelligence handoff | **CONFIRMED contract, bounded residual** | TDL-EVID-OQ001-HANDOFF-001: producer → `driving.intelligence.jobs`; not DB⊕queue atomic; 14d reconciliation; missing `organizationId` skip gap |
