...
| **CURRENT_ORIGIN_MAIN_SHA (REPO_CURRENT @ rebaseline)** | `d6ff7e198110ff7401d03389c232398af47766f0` |
| **PRODUCTION_AUDITED_AT (Qualified Stop V1 acceptance)** | `2026-09-25` |
| **PRODUCTION_RELEASE_SHA (current verified)** | `99d722b4cac865e59e30ad23c82cec11fd9fc9b1` |
| **PRODUCTION_RELEASE_PATH (current verified)** | `/opt/synqdrive/releases/20260924235024_v4994` |
...
**Baseline note:** Do not treat pre-R9 Production @ `01541c2ab…`, R9 @ `0ba96e03…`, or PRE_HARDENING_R12 @ `157b3c722…` as **PRODUCTION_CURRENT**. **PRODUCTION_CURRENT:** `99d722b4…` @ `20260924235024_v4994` (TDL-EVID-QS-V1-PROD-ACCEPT-001). **REPO_CURRENT:** `d6ff7e19…` — not identical to Production. See [CURRENT_STATE.md](CURRENT_STATE.md) authority axes.
...
| **2 — Production read-only audit** | **Verified** — historical sessions preserved; **PRODUCTION_CURRENT** @ `99d722b4…` (TDL-EVID-QS-V1-PROD-ACCEPT-001); PRE_HARDENING_R12 @ `157b3c722…` **HISTORICAL** |
...
### Production (read-only) — current verified @ `99d722b4…`
...
Preserved in [evidence/PRODUCTION_BASELINE.md](evidence/PRODUCTION_BASELINE.md). At this session R8/R9 were **NOT_ON_PRODUCTION** — do not conflate with **PRODUCTION_CURRENT** @ `99d722b4…`.
