...
| VDC-EVID-P25-POST-BOOTSTRAP-PROVENANCE-REFRESH-001 | P2.5 post-bootstrap same-state PROVENANCE_REFRESH GT-R1 proof | CURRENT_CODE + TEST | IMPLEMENTATION_PRESENT (not Production-deployed) | [P25_POST_BOOTSTRAP_PROVENANCE_REFRESH_GT_R1_2026-09-19.md](./P25_POST_BOOTSTRAP_PROVENANCE_REFRESH_GT_R1_2026-09-19.md) |
