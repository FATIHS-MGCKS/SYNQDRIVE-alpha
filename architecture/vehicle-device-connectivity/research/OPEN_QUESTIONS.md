...
| **VDC-Q-003** | What is the false-positive rate for standby vs offline at 24h/48h boundaries? | 2 | PRODUCTION_OBSERVATION | **Quantified for KS MX 2024** — 163–181 s transient `signal_delayed` per ~24 h cycle |
