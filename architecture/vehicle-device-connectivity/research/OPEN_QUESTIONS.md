...
| **VDC-Q-016** | How should canonical OBD plug-state be repaired when PLUG webhook disabled and last event is UNPLUGGED after SNAPSHOT_PLUG_SIGNAL resolution? | GT-R1 | PRODUCTION_OBSERVATION + CODE | **PARTIALLY_ANSWERED** | Phase 1: VDC-DEC-012 projection + self-heal path (snapshot PLUG repairs authority without episode); webhook cutover still deferred behind OFF flag | VDC-RB-019; VDC-DEC-012; VDC-EVID-GT-R1-EXECUTION-001 §6.1 | VDC |
