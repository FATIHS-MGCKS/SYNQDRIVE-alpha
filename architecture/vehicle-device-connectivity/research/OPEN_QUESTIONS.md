...
| **VDC-Q-016** | How should canonical OBD plug-state be repaired when PLUG webhook disabled and last event is UNPLUGGED after SNAPSHOT_PLUG_SIGNAL resolution? | GT-R1 | PRODUCTION_OBSERVATION + CODE | **ANSWERED (Phase 1)** | Phase 1 projection + self-heal path; Phase 2 cutover scoped in VDC-DEC-013 / audit 2026-09-13 | VDC-RB-019 P2; VDC-DEC-012/013 | VDC |
| **VDC-Q-017** | Minimum safe flag model for staged physical-state cutover (write vs authority vs side-effects)? | Phase 2 | ARCHITECTURE | **PROPOSED** | Four dimensions, all default OFF — VDC-DEC-013 | VDC-RB-019 P2 | VDC |
