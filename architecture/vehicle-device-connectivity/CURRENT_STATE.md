...
| **Last updated** | 2026-09-15 (RB-019 P2.5 cutover activation readiness audit — pre-seed dry-run PASS on Production read-only; UNEXPLAINED/mixed-replica/provenance NOT_PROVEN; cutover activation NOT_PROVEN) |
