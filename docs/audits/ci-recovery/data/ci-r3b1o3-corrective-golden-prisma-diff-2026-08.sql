...
-- CreateIndex
CREATE UNIQUE INDEX "org_role_asgn_drift_recon_apps_idem_key" ON "organization_role_assignment_drift_reconciliation_applications"("idempotency_key");

-- CreateIndex
CREATE INDEX "org_role_asgn_drift_recon_apps_org_mbr_created_idx" ON "organization_role_assignment_drift_reconciliation_applications"("organization_id", "membership_id", "created_at");
...
-- AddForeignKey
ALTER TABLE "organization_role_assignment_drift_reconciliation_applications" ADD CONSTRAINT "org_role_asgn_drift_recon_apps_org_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organization_role_assignment_drift_reconciliation_applications" ADD CONSTRAINT "org_role_asgn_drift_recon_apps_mbr_id_fkey" FOREIGN KEY ("membership_id") REFERENCES "organization_memberships"("id") ON DELETE CASCADE ON UPDATE CASCADE;
