#!/usr/bin/env python3
"""Targeted PostgreSQL proof using contract-compiled repair SQL (CI-R3B1F.1.1)."""
...
from ci_r3b1f111_constants import DATA, REPO, TIRE_CONSUMER
...
CONTRACTS = DATA / "ci-r3b1f111-exact-predecessor-contracts-2026-08.json"
OUT = DATA / "ci-r3b1f111-targeted-consumer-proof-2026-08.json"
