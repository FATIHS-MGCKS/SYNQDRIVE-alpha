#!/usr/bin/env python3
"""Capture pre-157 PostgreSQL catalog snapshot for tire lifecycle tables (CI-R3B1F.1.1)."""
...
from ci_r3b1f111_constants import DATA, PRE157_BOUNDARY, TIRE_PROPERTIES
from replay_evidence_lib import PgConfig, psql

OUT = DATA / "ci-r3b1f111-pre-157-catalog-snapshot-2026-08.json"
