#!/usr/bin/env python3
"""Replay disposable PostgreSQL through pre-249 boundary (CI-R3B1H.1.1)."""
...
from ci_r3b1h111_constants import DATA, PRE249_BOUNDARY
from replay_evidence_lib import PgConfig

OUT = DATA / "ci-r3b1h111-pre249-replay-state-2026-08.json"


def main() -> int:
    db = sys.argv[1] if len(sys.argv) > 1 else "synqdrive_r3b1h111_pre249"
    cfg = PgConfig()
