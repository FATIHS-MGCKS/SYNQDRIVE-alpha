#!/usr/bin/env python3
"""Immutability audit for CI-R3B1F.1."""
...
OUT = REPO / "docs/audits/ci-recovery/data/ci-r3b1f1-immutability-audit-2026-08.json"
BASE_SHA = "75ecaa637f7588a10d3b8d885ffb1830b0bfba9a"
