#!/usr/bin/env python3
"""Immutability audit for CI-R3B1F.1.1."""
...
OUT = REPO / "docs/audits/ci-recovery/data/ci-r3b1f111-immutability-audit-2026-08.json"
BASE_SHA = "6263e2455db23df226567ac95e2aff3f1b6a5f98"
...
def main() -> int:
    ...
    out = {
        ...
        "new_prisma_migration_directories": 0,
        ...
        "tire_lifecycle_invariants_changed": any(
            c["migration"] == "20260716183000_tire_lifecycle_invariants" for c in migration_changes
        ),
