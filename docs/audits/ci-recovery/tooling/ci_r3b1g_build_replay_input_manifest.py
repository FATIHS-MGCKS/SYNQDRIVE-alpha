#!/usr/bin/env python3
"""Build CI-R3B1G replay input manifest including new tire repair migration."""
...
from ci_r3b1g_constants import DATA, IMPLEMENTATION_AUTHORITY_FILES, REPO, R3B1G_REPAIR_MIGRATION

OUT = DATA / "ci-r3b1g-replay-input-manifest-2026-08.json"
...
def main() -> int:
    ...
    tooling = [
        ...
        "docs/audits/ci-recovery/tooling/ci_r3b1g_full_replay_harness.py",
        ...
        "docs/audits/ci-recovery/data/ci-r3b1g-implementation-authority-manifest-2026-08.json",
    ]
    for rel in tooling:
        path = REPO / rel
        if path.exists():
    ...
    out = {
        ...
        "r3b1g_repair_migration": R3B1G_REPAIR_MIGRATION,
        "files": files,
    }
