"""Shared constants for CI-R3B1L.1 exact parity and Prisma diff closure."""
...
R3B1L1_BRANCH = "fix/ci-r3b1l1-exact-parity-diff-closure-2026-08"
PARENT_BRANCH = "fix/ci-r3b1l-exact-final-parity-acceptance-2026-08"
...
R3B1L_AUTHORITY_MANIFEST = DATA / "ci-r3b1l-final-authority-manifest-2026-08.json"
...
R3B_OBJECT_NAMES = set(BOOTSTRAP_TABLES) | set(BOOTSTRAP_ENUMS)
...
FULL_REPLAY_DB = "synqdrive_r3b1l1_full_replay"

PG_MATCH_TYPE = {"s": "SIMPLE", "f": "FULL", "p": "PARTIAL"}
