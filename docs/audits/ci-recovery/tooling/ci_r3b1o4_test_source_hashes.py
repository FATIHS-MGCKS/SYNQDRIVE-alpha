...
BINDING_CORRECTIVE_SOURCE_FILES = FINAL_CORRECTIVE_SOURCE_FILES + [
...
def write_binding_corrective_test_source_hash_manifest(manifest: dict[str, str], *, pre_hashes: dict[str, str] | None = None) -> dict:
    ...
    (DATA / "ci-r3b1o4-binding-corrective-test-source-hash-manifest-2026-08.json").write_text(json.dumps(payload, indent=2) + "\n")
    (DATA / "ci-r3b1o4-binding-corrective-source-hash-manifest-2026-08.json").write_text(json.dumps(payload, indent=2) + "\n")
    return payload
