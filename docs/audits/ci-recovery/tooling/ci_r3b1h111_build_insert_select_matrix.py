#!/usr/bin/env python3
"""Build INSERT-SELECT dependency matrix 249→HEAD (CI-R3B1H.1.1)."""
...
from ci_r3b1h111_constants import DATA, FIRST_SCANNED, INSERT_SELECT_GAP_CONTEXTS, REPO, evidence_input_sha
...
OUT = DATA / "ci-r3b1h111-insert-select-dependency-matrix-2026-08.json"
