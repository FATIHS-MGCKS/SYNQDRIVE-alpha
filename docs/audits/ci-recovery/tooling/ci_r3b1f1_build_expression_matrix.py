#!/usr/bin/env python3
"""Build CI-R3B1F.1 expression-aware dependency matrix with corrected creator chronology."""
...
from ci_r3b1f1_constants import DATA, EXPRESSION_GAP_CONTEXTS, FIRST_SCANNED, PREVIOUS_PRIMARY_DEFECTS
...
OUT = DATA / "ci-r3b1f1-expression-aware-dependency-matrix-2026-08.json"
...
def build_matrix(repo: Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": 3,
        "phase": "CI-R3B1F.1",
        "supersedes": "ci-r3b1f-expression-aware-dependency-matrix-2026-08.json",
