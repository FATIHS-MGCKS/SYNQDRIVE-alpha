"""Independent authority coverage validator for CI-R3B1L.1."""
...
OUT = DATA / "ci-r3b1l1-authority-coverage-validation-2026-08.json"
...
def validate_coverage(parity: dict[str, Any], authority_ids: list[str] | None = None) -> dict[str, Any]:
    ...
    duplicates = sorted({aid for aid in evaluated if evaluated.count(aid) > 1})
