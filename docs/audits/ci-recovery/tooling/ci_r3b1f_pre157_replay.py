#!/usr/bin/env python3
"""Replay migrations through Slot 13 and stop before migration 157."""
...
from ci_r3b1f_constants import DATA, PRE157_BOUNDARY, TIRE_CONSUMER
...
OUT = DATA / "ci-r3b1f-pre157-replay-state-2026-08.json"
...
def run_pre157_replay(db_name: str = "synqdrive_r3b1f_pre157") -> dict:
    cfg = PgConfig()
