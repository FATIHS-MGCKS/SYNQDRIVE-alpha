#!/usr/bin/env python3
"""Replay migrations through Slot 13 and stop before migration 157 (CI-R3B1F.1.1)."""
...
from ci_r3b1f111_constants import DATA, PRE157_BOUNDARY, TIRE_CONSUMER
...
OUT = DATA / "ci-r3b1f111-pre157-replay-state-2026-08.json"
...
def run_pre157_replay(db_name: str = "synqdrive_r3b1f111_pre157") -> dict:
    cfg = PgConfig()
...
def main() -> int:
    db = sys.argv[1] if len(sys.argv) > 1 else "synqdrive_r3b1f111_pre157"
