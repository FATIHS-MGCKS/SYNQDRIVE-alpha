"""Final winning-strategy twin execution with real idempotency snapshots (CI-R3B1O.2)."""
...
from ci_r3b1o2_constants import FINAL_STRATEGY_DB_PREFIX
...
def build_temp_forward_m252_migration() -> tuple[Path, dict[str, Any]]:
    ...
    name = f"{ts}_ci_r3b1o2_strategy_m252_forward_reconciliation"
    ...
    tmp_root = Path(tempfile.mkdtemp(prefix="r3b1o2_m252_fwd_"))
