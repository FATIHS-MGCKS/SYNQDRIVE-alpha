...
| DI-EV-0026 | Phase 3A.3 | C — Ground Truth index | `docs/audits/dimo-lte-r1-reference-drive-002-ground-truth-evidence-index-2026-09-02.md` | 2026-09-02 | CURRENT | — | DIMO_LTE_R1 | ICE_GASOLINE | `DIMO_LTE_R1_REFERENCE_DRIVE_002` | CONFIRMED_FROM_PROTOCOL | — | — | Video GT NOT_PLANNED_BY_PROTOCOL (not REJECTED); RD003 reserved for video GT |
