...
| DI-EV-0016 | Phase 3A.3 | A — Reference drive report | `docs/audits/dimo-lte-r1-reference-drive-001-capture-report-2026-09-01.md` | 2026-09-01 | CURRENT | DIMO | DIMO_LTE_R1 | ICE_GASOLINE | VW Tiguan `19fedd4b-…` · session `06638509-…` · `DIMO_LTE_R1_REFERENCE_DRIVE_001` | CONFIRMED_FROM_RUNTIME | — | — | Real-motion STOP + telemetry audit; HF aggregation semantics corrected; exact-window replay; video GT NOT_AVAILABLE |
