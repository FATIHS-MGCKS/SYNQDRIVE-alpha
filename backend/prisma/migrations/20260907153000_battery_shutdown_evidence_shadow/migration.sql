...
CREATE TABLE "battery_shutdown_evidence_observations" (
  ...
  "effective_capture_reference_at" TIMESTAMP(3) NOT NULL,
  "provider_response_at" TIMESTAMP(3) NOT NULL,
  "ingested_at" TIMESTAMP(3) NOT NULL,
  "voltage" DOUBLE PRECISION,
  "voltage_observed_at" TIMESTAMP(3),
  "speed_kmh" DOUBLE PRECISION,
  "speed_observed_at" TIMESTAMP(3),
  "speed_timestamp_source" TEXT,
  "ignition_on" BOOLEAN,
  "ignition_observed_at" TIMESTAMP(3),
  "ignition_timestamp_source" TEXT,
  "engine_running" BOOLEAN,
  "engine_running_observed_at" TIMESTAMP(3),
  "engine_running_timestamp_source" TEXT,
  "is_lv_charging" BOOLEAN,
  "is_hv_charging" BOOLEAN,
  "charging_context_observed_at" TIMESTAMP(3),
  "charging_context_timestamp_source" TEXT,
  "active_trip" BOOLEAN,
  "active_trip_observed_at" TIMESTAMP(3),
  ...
  "vehicle_online_observed_at" TIMESTAMP(3),
  "provider_last_seen_at" TIMESTAMP(3),
...
CREATE TABLE "battery_trip_shutdown_contexts" (
  ...
  "trip_ended_at" TIMESTAMP(3) NOT NULL,
  ...
  "first_observation_after_trip_end_at_at_capture" TIMESTAMP(3),
  "idempotency_key" TEXT NOT NULL,
  "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
