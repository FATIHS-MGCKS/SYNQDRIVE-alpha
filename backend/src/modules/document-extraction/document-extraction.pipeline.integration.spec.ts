...
import { makeLifecycleMock, makeMalwareScanMock, makeRetentionMock, makeUploadContextMock, makeVehicleCandidateResolverMock, makeBookingCandidateResolverMock, makeCustomerCandidateResolverMock } from './document-extraction-test.helpers';
