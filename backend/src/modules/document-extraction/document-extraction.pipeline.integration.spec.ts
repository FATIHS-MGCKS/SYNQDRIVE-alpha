...
import { makeLifecycleMock, makeMalwareScanMock, makeRetentionMock, makeUploadContextMock, makeVehicleCandidateResolverMock, makeBookingCandidateResolverMock, makeCustomerCandidateResolverMock, makeDriverCandidateResolverMock } from './document-extraction-test.helpers';
