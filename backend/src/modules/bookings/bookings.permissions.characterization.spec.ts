...
describe('BookingsController permissions characterization', () => {
  ...
  const mutationHandlers = [
    ...
    ['updateSchedule', 'booking.update_schedule'],
    ['updateCustomer', 'booking.update_customer'],
    ['updateVehicle', 'booking.update_vehicle'],
    ['updateStations', 'booking.update_stations'],
    ['updateNotes', 'booking.update_notes'],
    ['updateOptions', 'booking.update_options'],
    ['updateAllowedDrivers', 'booking.update_allowed_drivers'],
