...
export const FUEL_STATION_GROUND_TRUTH_CASES: FuelStationGroundTruthCase[] = [
  ...
  },
  {
    ...
    label: 'Berlin Brandenburg Gate area (city reference — not on-station)',
    latitude: 52.52,
    longitude: 13.405,
    scenario: 'urban',
  },
  {
    id: 'munich-center',
    label: 'Munich center (city reference — not on-station)',
    latitude: 48.1351,
    longitude: 11.582,
    scenario: 'urban',
  },
  {
    id: 'hamburg-center',
    label: 'Hamburg center (city reference — not on-station)',
    latitude: 53.5511,
    longitude: 9.9937,
    scenario: 'urban',
  },
  {
    id: 'frankfurt-center',
    label: 'Frankfurt center (city reference — not on-station)',
    latitude: 50.1109,
    longitude: 8.6821,
    scenario: 'urban',
  },
