...
import type { BatteryLongitudinalProfileRevision, Prisma } from '@prisma/client';
...
export class LongitudinalProfileMaterializationRepository {
  ...
  /**
   * PostgreSQL-safe idempotent insert (READ COMMITTED + ON CONFLICT DO NOTHING RETURNING).
   */
