...
export type M3_3E_HealthEvaluationRejectReason =
  ...
  | 'M3_3E_EVALUATION_MODEL_SUFFICIENCY_MISMATCH'
  | 'M3_3E_EVALUATION_MALFORMED_COVERAGE'
  | 'M3_3E_EVALUATION_MALFORMED_FEATURE_NUMERIC'
  | 'M3_3E_EVALUATION_MALFORMED_SEGMENT_STRUCTURE'
  | 'M3_3E_EVALUATION_SHUTDOWN_DELTA_ANCHOR_INCONSISTENT'
  | 'M3_3E_EVALUATION_UNSUPPORTED_CALIBRATION_PROFILE'
  | 'M3_3E_EVALUATION_CHARGE_CLASS_MIRROR_MISMATCH'
