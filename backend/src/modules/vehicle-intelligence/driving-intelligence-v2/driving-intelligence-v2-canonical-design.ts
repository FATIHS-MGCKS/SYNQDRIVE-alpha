...
export const DRIVING_STATE_MODEL = {
  purpose: 'Temporally persistent states before episode/event classification',
  antiPattern: 'one_sample_state_flipping',
  states: [
    'STANDSTILL',
    'LAUNCH',
    'LOW_SPEED_MOTION',
    ...
    'STOP_APPROACH',
    'STOPPED',
    'REVERSE_OR_DIRECTION_CONTEXT',
    'HIGH_POWERTRAIN_DEMAND',
...
export const EPISODE_TAXONOMY = {
  ...
  coreTypes: [
    ...
    'LAUNCH_EPISODE',
    'STOP_APPROACH_EPISODE',
    'CRUISE_EPISODE',
    'HIGH_POWERTRAIN_DEMAND_EPISODE',
    'STANDSTILL_EPISODE',
  ],
  ...
  severityModel: {
    type: 'continuous_multi_dimensional',
    dimensions: [
...
export const EPISODE_CONFIDENCE_MODEL = {
  ...
  rule: 'No score calculation without episode confidence',
} as const;
...
export const TRIP_FEATURE_VECTOR = {
  ...
  features: [
    ...
    'accelP90Mps2',
    'accelP95Mps2',
    'positiveAccelerationEnergyProxy',
    'negativeAccelerationEnergyProxy',
    'speedVariability',
    'stopCount',
    'launchCount',
    'highPowertrainDemandFraction',
    'episodeConfidenceDistribution',
    'telemetryCoverage',
...
export const HIGH_TIMEFRAME_AGGREGATION = {
  ...
  antiPatterns: ['overreact_to_single_trip', 'raw_event_count_without_exposure'],
...
export const BRAKE_LOAD_FOUNDATION = {
  ...
  futureModel: {
    LONGITUDINAL_DECELERATION_LOAD: {
      observable: true,
      proxies: ['speed_reduction_magnitude', 'initial_speed', 'deceleration_intensity', 'sustained_duration', 'kinetic_energy_change_proxy', 'frequency'],
    },
...
export const TIRE_LOAD_FOUNDATION = {
  ...
  futureComponents: {
    ...
    SPEED_THERMAL_EXPOSURE: { observable: 'PROXY_FROM_SPEED_DURATION', confidence: 'MEDIUM' },
...
export const CONTEXT_FAIRNESS = {
  ...
  policy: 'Reduce confidence where context unknown — do not implement corrections without evidence',
} as const;
...
export const MIGRATION_PLAN = {
  phases: [
    { id: 'DI-EV-0034F', title: 'Canonical Driving Intelligence Design', status: 'CURRENT' },
...
export function assertDesignInvariants(): void {
  ...
  if (!EPISODE_CONFIDENCE_MODEL.rule.includes('without episode confidence')) {
    violations.push('score requires episode confidence');
  }
