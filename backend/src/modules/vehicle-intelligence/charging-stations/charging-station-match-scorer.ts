...
import type { ChargingStationMatchFeatures } from './charging-station-location.types';
...
export function enrichCandidateFeatures(
  features: Omit<
    ChargingStationMatchFeatures,
    'distanceRank' | 'secondCandidateGapMeters' | 'secondCandidateGapRatio'
  >,
  rank: number,
  second?: Pick<ChargingStationMatchFeatures, 'geometryDistanceMeters'> | null,
): ChargingStationMatchFeatures {
