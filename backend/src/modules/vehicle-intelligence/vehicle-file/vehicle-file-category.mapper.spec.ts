...
function ext(
  ...
  return {
    ...
    vehicleId: 'v1',
    organizationId: 'org1',
    requestedDocumentType: partial.requestedDocumentType ?? partial.documentType,
    effectiveDocumentType: partial.effectiveDocumentType ?? partial.documentType,
    classificationMode: partial.classificationMode ?? 'MANUAL',
    detectedDocumentType: partial.detectedDocumentType ?? null,
    classificationConfidence: partial.classificationConfidence ?? null,
    processingStage: partial.processingStage ?? 'REVIEW',
    errorPhase: partial.errorPhase ?? null,
    errorCode: partial.errorCode ?? null,
    processingAttempts: partial.processingAttempts ?? 0,
    ocrProvider: partial.ocrProvider ?? null,
    ocrModel: partial.ocrModel ?? null,
    extractionProvider: partial.extractionProvider ?? null,
    extractionModel: partial.extractionModel ?? null,
    ocrPageCount: partial.ocrPageCount ?? null,
    processingStartedAt: partial.processingStartedAt ?? null,
    ocrCompletedAt: partial.ocrCompletedAt ?? null,
    classificationCompletedAt: partial.classificationCompletedAt ?? null,
    extractionCompletedAt: partial.extractionCompletedAt ?? null,
    processingCompletedAt: partial.processingCompletedAt ?? null,
    nextRetryAt: partial.nextRetryAt ?? null,
    cancelledAt: partial.cancelledAt ?? null,
    cancelledById: partial.cancelledById ?? null,
    confirmedById: partial.confirmedById ?? null,
    appliedById: partial.appliedById ?? null,
    fileDeletedById: partial.fileDeletedById ?? null,
    fileDeletedAt: partial.fileDeletedAt ?? null,
