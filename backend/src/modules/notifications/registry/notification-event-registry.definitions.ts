...
export const NOTIFICATION_EVENT_TYPE_DEFINITIONS = [
  ...
  {
    slug: 'vehicle-readiness-unevaluable',
    eventType: 'VEHICLE_READINESS_UNEVALUABLE',
    attentionScope: 'FLEET_READINESS',
    domain: NotificationDomain.OPERATIONS,
    defaultEntityType: NotificationEntityType.VEHICLE,
    conditionCode: 'vehicle_readiness_unevaluable',
    fingerprintVersion: 1,
    eventKind: NotificationEventKind.STATE,
    defaultSeverity: NotificationSeverity.WARNING,
    allowedSeverityEscalations: [NotificationSeverity.WARNING],
    titleKey: 'notification.title.vehicleReadinessUnevaluable',
    bodyKey: 'notification.body.vehicleReadinessUnevaluable',
    requiredTemplateParams: ['label'],
    actionType: NotificationActionType.OPEN_VEHICLE,
    actionTargetBuilder: vehicleTarget,
    sourceType: NotificationSourceType.OPERATIONAL_ISSUE,
  ...
  {
    slug: 'limp-mode-active',
    eventType: 'LIMP_MODE_ACTIVE',
    attentionScope: 'FLEET_READINESS',
    domain: NotificationDomain.VEHICLE_HEALTH,
    defaultEntityType: NotificationEntityType.VEHICLE,
    conditionCode: 'limp_mode_active',
    fingerprintVersion: 1,
    eventKind: NotificationEventKind.STATE,
    defaultSeverity: NotificationSeverity.CRITICAL,
    allowedSeverityEscalations: [NotificationSeverity.WARNING, NotificationSeverity.CRITICAL],
    titleKey: 'notification.title.limpModeActive',
    bodyKey: 'notification.body.limpModeActive',
    requiredTemplateParams: ['label'],
    actionType: NotificationActionType.OPEN_VEHICLE_MODULE,
    actionTargetBuilder: vehicleModuleTarget('health'),
    sourceType: NotificationSourceType.HEALTH_ALERT,
  ...
  {
    slug: 'engine-oil-level-low',
    eventType: 'ENGINE_OIL_LEVEL_LOW',
    attentionScope: 'FLEET_READINESS',
    domain: NotificationDomain.VEHICLE_HEALTH,
    defaultEntityType: NotificationEntityType.VEHICLE,
    conditionCode: 'engine_oil_level_low',
    fingerprintVersion: 1,
    eventKind: NotificationEventKind.STATE,
    defaultSeverity: NotificationSeverity.CRITICAL,
    allowedSeverityEscalations: [NotificationSeverity.WARNING, NotificationSeverity.CRITICAL],
    titleKey: 'notification.title.engineOilLevelLow',
    bodyKey: 'notification.body.engineOilLevelLow',
    requiredTemplateParams: ['label'],
    actionType: NotificationActionType.OPEN_VEHICLE_MODULE,
    actionTargetBuilder: vehicleModuleTarget('health'),
    sourceType: NotificationSourceType.HEALTH_ALERT,
  ...
  {
    slug: 'engine-oil-level-high',
    eventType: 'ENGINE_OIL_LEVEL_HIGH',
    attentionScope: 'FLEET_READINESS',
    domain: NotificationDomain.VEHICLE_HEALTH,
    defaultEntityType: NotificationEntityType.VEHICLE,
    conditionCode: 'engine_oil_level_high',
    fingerprintVersion: 1,
    eventKind: NotificationEventKind.STATE,
    defaultSeverity: NotificationSeverity.WARNING,
    allowedSeverityEscalations: [NotificationSeverity.WARNING, NotificationSeverity.CRITICAL],
    titleKey: 'notification.title.engineOilLevelHigh',
    bodyKey: 'notification.body.engineOilLevelHigh',
    requiredTemplateParams: ['label'],
    actionType: NotificationActionType.OPEN_VEHICLE_MODULE,
    actionTargetBuilder: vehicleModuleTarget('health'),
    sourceType: NotificationSourceType.HEALTH_ALERT,
  ...
  {
    slug: 'vehicle-damage-blocking',
    eventType: 'VEHICLE_DAMAGE_BLOCKING',
    attentionScope: 'FLEET_READINESS',
    domain: NotificationDomain.VEHICLE_HEALTH,
    defaultEntityType: NotificationEntityType.VEHICLE,
    conditionCode: 'vehicle_damage_blocking',
    fingerprintVersion: 1,
    eventKind: NotificationEventKind.STATE,
    defaultSeverity: NotificationSeverity.WARNING,
    allowedSeverityEscalations: [NotificationSeverity.WARNING, NotificationSeverity.CRITICAL],
    titleKey: 'notification.title.vehicleDamageBlocking',
    bodyKey: 'notification.body.vehicleDamageBlocking',
    requiredTemplateParams: ['label'],
    actionType: NotificationActionType.OPEN_VEHICLE_MODULE,
    actionTargetBuilder: vehicleModuleTarget('damages'),
    sourceType: NotificationSourceType.OPERATIONAL_ISSUE,
    resolutionPolicy: STATE_RESOLUTION,
    deliveryPolicy: DEFAULT_CRITICAL_DELIVERY,
    preferenceCategory: NotificationCategory.DAMAGE_MISUSE,
  ...
  {
    slug: 'communication-handoff-required',
    eventType: 'COMMUNICATION_HANDOFF_REQUIRED',
    attentionScope: 'OPERATIONS',
    domain: NotificationDomain.OPERATIONS,
    defaultEntityType: NotificationEntityType.ORGANIZATION,
    conditionCode: 'handoff_required',
    fingerprintVersion: 1,
    eventKind: NotificationEventKind.EVENT,
    defaultSeverity: NotificationSeverity.WARNING,
    allowedSeverityEscalations: [NotificationSeverity.WARNING, NotificationSeverity.CRITICAL],
    titleKey: 'notification.title.communicationHandoffRequired',
    bodyKey: 'notification.body.communicationHandoffRequired',
    requiredTemplateParams: ['contactDisplay', 'channelLabel'],
    actionType: NotificationActionType.OPEN_COMMUNICATION,
    actionTargetBuilder: communicationTarget,
    sourceType: NotificationSourceType.RUNTIME,
    resolutionPolicy: EVENT_RESOLUTION,
    expiryPolicy: SHORT_EVENT_EXPIRY,
    deliveryPolicy: DEFAULT_CRITICAL_DELIVERY,
