...
export function aggregateStationOrgGlobalKpis(
  ...
  return {
    ...
    notReadyOnSite: sumKnownMetric(summaries, 'notReadyOnSite'),
    blockedOrMaintenanceOnSite: sumKnownMetric(summaries, 'blockedOrMaintenanceOnSite'),
    criticalOnSite: sumKnownMetric(summaries, 'criticalOnSite'),
    warningOnSite: sumKnownMetric(summaries, 'warningOnSite'),
    telemetryOfflineOnSite: sumKnownMetric(summaries, 'telemetryOfflineOnSite'),
    complianceBlockerOnSite: sumKnownMetric(summaries, 'complianceBlockerOnSite'),
    vehiclesWithHealthWarningsOnSite: sumKnownMetric(
      summaries,
      'vehiclesWithHealthWarningsOnSite',
    ),
