/** Active ISO 4217 alphabetic currency codes (canonical shared allowlist). */
export const ISO4217_CURRENCY_CODES: ReadonlySet<string> = new Set([
...
export function isIso4217CurrencyCode(value: string): boolean {
  return ISO4217_CURRENCY_CODES.has(value.trim().toUpperCase());
}
