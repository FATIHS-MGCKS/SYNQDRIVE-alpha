...
import { EvaluationsRecommendationsModule } from '@modules/evaluations-analytics/e7/evaluations-recommendations.module';
  ...
  static async forRootAsync(): Promise<DynamicModule> {
    ...
    return {
      ...
      imports: [
        ...
        EvaluationsRecommendationsModule,
        HighMobilityModule,
        RentalHealthModule,
