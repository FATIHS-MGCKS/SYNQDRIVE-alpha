/**
 * One-shot migration helper for 20260417180000_add_battery_critical_insight_type.
 *
 ...
 *
 * Usage:
 *   npx ts-node -r tsconfig-paths/register scripts/apply-battery-critical-enum.ts
 *
...
const MIGRATION_NAME = '20260417180000_add_battery_critical_insight_type';
const MIGRATION_SQL =
...
async function main() {
  ...
  try {
    console.log(`[apply-enum] Applying enum value BATTERY_CRITICAL...`);
