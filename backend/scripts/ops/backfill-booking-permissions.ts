/**
 * Backfill granular booking permission modules onto existing system role templates.
 *
 * Usage (from backend/):
...
async function main() {
  ...
  console.log(`Backfilled booking permissions on ${updated} system role templates.`);
}
