      ...
      JSON.stringify(
        {
          ...
          createdConsents: summary.createdConsents,
          wiredConsentIds: summary.wiredConsentIds,
          mutatedVehicles: summary.mutatedVehicles,
          noopVehicles: summary.noopVehicles,
          vehicles: enriched,
        },
        null,
        2,
