...
export function OperatorHandoverStepCondition({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className=" border border-border/60 surface-premium p-4 space-y-3">
      ...
      {(kind === 'RETURN' || !form.state.checks.tiresSeasonOk) && onTireMeasure && (
        <button
          ...
          className="sq-press flex min-h-[48px] w-full items-center gap-3 surface-premium px-4 text-left"
        >
