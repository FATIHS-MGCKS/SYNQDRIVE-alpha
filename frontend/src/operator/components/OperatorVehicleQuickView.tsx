    ...
    <div className="space-y-4 pb-4">
      ...
      <OperatorGlassCard className="overflow-hidden p-0">
        <div className="bg-gradient-to-br from-[color:var(--brand-soft)]/80 to-card p-5">
          ...
          <div className="mt-4 rounded-md border border-border/60 bg-background/70 px-4 py-3">
      ...
      <div className="grid gap-2">
        {pickupItem && (
          <button
            ...
            onClick={openPickup}
            className="sq-press flex min-h-[52px] items-center gap-3 rounded-lg border border-[color:var(--brand)]/30 bg-[color:var(--brand-soft)] px-4 text-left disabled:opacity-50"
          >
        ...
        {returnItem && (
          <button
            ...
            onClick={openReturn}
            className="sq-press flex min-h-[52px] items-center gap-3 border border-border/60 surface-premium px-4 text-left disabled:opacity-50"
          >
        ...
        <button
          ...
          className="sq-press flex min-h-[52px] items-center gap-3 border border-border/60 surface-premium px-4 text-left"
        >
