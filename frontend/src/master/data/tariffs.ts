...
export const categoryConfig: Record<VehicleCategory, { icon: string; color: string; bg: string; darkBg: string; text: string; darkText: string; border: string; darkBorder: string }> = {
  'All': { icon: '\u{1F697}', color: 'blue', bg: 'bg-brand-soft', darkBg: 'bg-status-info-soft', text: 'text-status-info', darkText: 'text-status-info', border: 'border-brand/40', darkBorder: 'border-brand/60' },
  ...
  'MPV': { icon: '\u{1F690}', color: 'indigo', bg: 'bg-status-info-soft', darkBg: 'bg-status-info-soft', text: 'text-status-info', darkText: 'text-status-info', border: 'border-status-info/40', darkBorder: 'border-status-info/40' },
};
