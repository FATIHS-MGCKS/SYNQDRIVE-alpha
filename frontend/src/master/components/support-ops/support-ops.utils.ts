...
export const sop = {
  ...
  kpiStrip: 'surface-frosted border border-border/45 px-3 py-2',
  queueCol:
    'hidden lg:flex lg:flex-col lg:w-[188px] shrink-0 surface-frosted border border-border/45 overflow-hidden',
  inboxCol: 'flex min-w-0 flex-1 flex-col surface-frosted border border-border/45 overflow-hidden',
  workspaceCol:
    'hidden xl:flex xl:w-[min(440px,34vw)] shrink-0 flex-col surface-frosted border border-border/45 overflow-hidden',
  queueBtn:
