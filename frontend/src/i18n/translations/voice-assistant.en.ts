export const voiceAssistantEn = {
  ...
  'voice.telephony.stepStatus.error': 'Error',
  ...
  'voice.test.phase.error': 'Error',
  'voice.test.phase.ready': 'Ready to test',
  'voice.test.row.provider': 'Provider',
  'voice.test.row.agent': 'Agent',
  'voice.test.row.voice': 'Voice',
  'voice.test.row.providerConnected': 'ElevenLabs connected',
  'voice.test.row.notConnected': 'Not connected',
