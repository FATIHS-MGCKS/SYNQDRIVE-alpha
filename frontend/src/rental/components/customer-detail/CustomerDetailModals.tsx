...
export function CustomerNoteModal({ open, saving, onClose, onConfirm }: CustomerNoteModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="w-full max-w-md surface-premium p-5 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 w-full text-xs px-3 py-2 rounded-lg surface-premium"
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="mt-1 w-full text-xs px-3 py-2 rounded-lg surface-premium resize-none"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="w-full max-w-md surface-premium p-5 space-y-4">
        ...
        <textarea
          ...
          rows={3}
          className="w-full text-xs px-3 py-2 rounded-lg surface-premium resize-none"
