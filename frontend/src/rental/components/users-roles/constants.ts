...
export const PERMISSION_MODULES: PermissionModuleDef[] = [
  ...
  { key: 'bookings-sensitive', label: 'Buchungen (sensibel)', icon: Calendar, group: 'Buchungen' },
  { key: 'bookings-schedule', label: 'Buchungen (Zeitplan)', icon: Calendar, group: 'Buchungen' },
  { key: 'bookings-customer', label: 'Buchungen (Kunde)', icon: Calendar, group: 'Buchungen' },
  { key: 'bookings-vehicle', label: 'Buchungen (Fahrzeug)', icon: Calendar, group: 'Buchungen' },
  { key: 'bookings-finance', label: 'Buchungen (Finanzen)', icon: CreditCard, group: 'Buchungen' },
  { key: 'bookings-documents', label: 'Buchungen (Dokumente)', icon: FileText, group: 'Buchungen' },
  { key: 'bookings-handover', label: 'Buchungen (Übergabe)', icon: Calendar, group: 'Buchungen' },
  { key: 'bookings-audit', label: 'Buchungen (Audit)', icon: FileText, group: 'Buchungen' },
