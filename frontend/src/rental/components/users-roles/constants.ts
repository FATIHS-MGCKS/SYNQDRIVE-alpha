...
export const PERMISSION_MODULES: PermissionModuleDef[] = [
  ...
  { key: 'workflow-automation-publish', label: 'Workflows veröffentlichen', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-test', label: 'Workflow Dry-Run Tests', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-test-external', label: 'Workflow External Tests', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-approval', label: 'Workflow-Freigaben', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-runs', label: 'Workflow-Läufe', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-audit', label: 'Workflow-Audit', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-dead-letter', label: 'Workflow Dead Letter', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-secrets', label: 'Workflow-Geheimnisse', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-policy', label: 'Workflow-Kommunikationsrichtlinien', icon: Zap, group: 'Workflow' },
  { key: 'workflow-automation-templates', label: 'Workflow-Vorlagen', icon: Zap, group: 'Workflow' },
