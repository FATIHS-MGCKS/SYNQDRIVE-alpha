...
export const PERMISSION_MODULES: PermissionModuleDef[] = [
  ...
  { key: 'payments', label: 'Kundenzahlungen', icon: CreditCard, group: 'Finanzen' },
  { key: 'payments-refund', label: 'Erstattungen', icon: CreditCard, group: 'Finanzen' },
  { key: 'payments-disputes', label: 'Zahlungsstreitigkeiten', icon: CreditCard, group: 'Finanzen' },
  { key: 'payments-connect', label: 'Stripe Connect', icon: CreditCard, group: 'Finanzen' },
  { key: 'payments-settings', label: 'Zahlungseinstellungen', icon: CreditCard, group: 'Finanzen' },
  ...
  { key: 'rental-rules', label: 'Mietregeln', icon: Tag, group: 'Preise & Tarife' },
  { key: 'rental-rules-publish', label: 'Mietregeln veröffentlichen', icon: Tag, group: 'Preise & Tarife' },
  { key: 'rental-rules-assign', label: 'Mietregeln Fahrzeugzuordnung', icon: Car, group: 'Preise & Tarife' },
  { key: 'rental-rules-overrides', label: 'Mietregeln Fahrzeug-Overrides', icon: Car, group: 'Preise & Tarife' },
  { key: 'booking-eligibility', label: 'Buchungs-Eligibility prüfen', icon: Calendar, group: 'Buchungen' },
  { key: 'booking-eligibility-override', label: 'Eligibility-Ausnahmen', icon: Calendar, group: 'Buchungen' },
  ...
  { key: 'evaluations', label: 'Auswertungen (Executive)', icon: Activity, group: 'Insights' },
  { key: 'evaluations-finance', label: 'Auswertungen Finanzen', icon: FileText, group: 'Insights' },
  { key: 'evaluations-receivables', label: 'Auswertungen Forderungen', icon: FileText, group: 'Insights' },
  { key: 'evaluations-customer-pii', label: 'Auswertungen Kunden-PII', icon: Users, group: 'Insights' },
  { key: 'evaluations-driver', label: 'Auswertungen Fahrer', icon: Car, group: 'Insights' },
  { key: 'evaluations-costs', label: 'Auswertungen Kosten', icon: FileText, group: 'Insights' },
  { key: 'evaluations-forecasts', label: 'Auswertungen Prognosen', icon: Activity, group: 'Insights' },
  { key: 'evaluations-data-quality', label: 'Auswertungen Datenqualität', icon: Activity, group: 'Insights' },
  { key: 'evaluations-recommendations', label: 'Auswertungen Empfehlungen', icon: Zap, group: 'Insights' },
  { key: 'evaluations-assignees', label: 'Auswertungen Zuweisungen', icon: UserCog, group: 'Insights' },
  { key: 'evaluations-export', label: 'Auswertungen Export', icon: Upload, group: 'Insights' },
  { key: 'evaluations-admin', label: 'Auswertungen Admin', icon: Lock, group: 'Insights' },
