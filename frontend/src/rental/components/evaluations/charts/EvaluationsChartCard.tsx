...
export function EvaluationsChartCard({
  ...
  return (
    <article
      className={cn(
        'surface-premium rounded-2xl border border-border/40 p-4 shadow-[var(--shadow-1)]',
        className,
      )}
    ...
    >
      ...
      <div className="relative min-h-[200px]" role="img" aria-labelledby={`${chartId}-title`} aria-describedby={`${chartId}-table`}>
        {!hasData ? (
      ...
      <div id={`${chartId}-table`} className="mt-4 border-t border-border/40 pt-3">
