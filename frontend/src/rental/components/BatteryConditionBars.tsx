...
const STATUS_STYLES: Record<AnyBatteryStatus, StatusStyle> = {
  ...
  UNKNOWN: { bars: 0, label: 'Unknown', fill: 'bg-gray-400', textLight: 'text-muted-foreground', textDark: 'text-muted-foreground' },
  UNSUPPORTED: { bars: 0, label: 'Not rated', fill: 'bg-gray-400', textLight: 'text-muted-foreground', textDark: 'text-muted-foreground' },
};
