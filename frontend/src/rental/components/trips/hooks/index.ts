...
export { useVehicleTrips } from './useVehicleTrips';
export type { TimelineLoadSource } from './useVehicleTrips';
...
/** @deprecated Timeline items come from useVehicleTrips (canonical API). */
export { useTripsTimeline } from './useTripsTimeline';
