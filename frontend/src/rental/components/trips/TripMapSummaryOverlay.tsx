    ...
    <div className="pointer-events-none absolute top-2.5 left-2.5 z-20 max-w-[min(18rem,calc(100%-5.5rem))]">
      <div className="sq-map-liquid-glass pointer-events-auto px-3 py-2.5">
        ...
        <div className="mt-2 flex items-center gap-2 flex-wrap">
          ...
          />
          <span className={`text-[9px] font-semibold uppercase tracking-wider ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
            {tripStressStatusLabel(trip)}
          </span>
          {trip.tripStatus === 'ONGOING' && (
            <span className="sq-map-liquid-badge sq-map-liquid-badge--status sq-map-liquid-badge--watch py-0.5 px-1.5 text-[9px]">
