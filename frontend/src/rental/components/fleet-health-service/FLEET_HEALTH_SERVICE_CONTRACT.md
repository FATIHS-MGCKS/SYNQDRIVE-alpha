...
## 1. Scope & Renderpfad (aktuell, V4.9.182)
...
| Fleet Top-Tabs | `FleetHubView.tsx` | **`Status`** \| **`Zustand & Service`** |
| Tab **Zustand & Service** | `FleetHealthServiceView.tsx` | Interne Subtabs (sq-tab-bar) |
| Subtab **Fahrzeuge** | `FleetConditionView` | Bisheriger Health-Inhalt |
| Subtabs **Übersicht / Aufgaben / …** | `ServiceCenterView` (`forcedTab`, `hideSubTabBar`) | Bisheriger Service-Center-Inhalt |
