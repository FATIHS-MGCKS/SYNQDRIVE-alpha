...
export const sc = {
  ...
  controlBar: 'surface-frosted rounded-lg p-3 sm:p-4',
  kpiGrid: 'grid grid-cols-2 sm:grid-cols-4 gap-2',
  kpiTile:
    'surface-elevated px-3 py-2.5 text-left transition-all hover:-translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--brand)]',
  kpiTileActive: 'ring-1 ring-[color:color-mix(in_srgb,var(--brand)_25%,transparent)] bg-[color:var(--brand-soft)]',
  panel: 'surface-premium p-4 min-w-0 overflow-hidden',
