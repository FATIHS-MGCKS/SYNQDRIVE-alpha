...
export const sc = {
  ...
  controlBar:
    'surface-frosted rounded-2xl border border-border/45 p-3 sm:p-4 shadow-[var(--shadow-1)]',
  ...
  panel: 'surface-premium rounded-2xl border border-border/45 p-4 shadow-[var(--shadow-1)] min-w-0',
