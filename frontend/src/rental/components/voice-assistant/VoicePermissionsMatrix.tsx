...
export function VoicePermissionsMatrix({
  ...
  return (
    <div className="space-y-4">
      <div className="surface-premium border border-border/40 p-4 sm:p-5">
      ...
      {pendingConfirm && (
        <div className="surface-premium border border-[color:var(--status-critical)]/30 bg-[color:var(--status-critical)]/[0.04] p-4">
      ...
      <div className="surface-premium overflow-hidden border border-border/40">
