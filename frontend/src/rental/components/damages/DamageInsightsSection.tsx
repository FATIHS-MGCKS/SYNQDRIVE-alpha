...
export function DamageInsightsSection({
  ...
  if (statsUnavailable && !cards.length) {
    return (
      <div className="surface-premium border border-amber-500/25 bg-amber-500/5 px-3 py-2.5">
  ...
  if (!cards.length) {
    return (
      <div className="surface-premium border border-border/60 px-3 py-2.5">
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="surface-premium border border-border/60 overflow-hidden">
