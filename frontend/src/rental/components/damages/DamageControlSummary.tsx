...
export function DamageControlSummary({
  ...
  return (
    <div className="space-y-2.5">
      <div
        className={`surface-premium surface-premium flex flex-col gap-2.5 border px-3 py-2.5 sm:flex-row sm:items-center sm:justify-between sm:px-3.5 ${SURFACE_CLASS[surfaceTone]}`}
      >
