...
export function DamageControlSummary({
  ...
  return (
    <div className="space-y-2.5">
      <div
        className={`sq-card flex flex-col gap-2.5 rounded-2xl border px-3 py-2.5 backdrop-blur-md sm:flex-row sm:items-center sm:justify-between sm:px-3.5 ${SURFACE_CLASS[surfaceTone]}`}
      >
