...
export function StationAssignVehicleModal({ station, onClose, onSaved }: StationAssignVehicleModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative w-full sm:max-w-xl max-h-[90vh] surface-premium rounded-t-dialog sm: flex flex-col animate-fade-up">
        ...
        <div className="p-4 space-y-3 border-b border-border/60">
          <input
            ...
            className="w-full px-3 py-2 rounded-lg surface-premium text-sm"
          />
