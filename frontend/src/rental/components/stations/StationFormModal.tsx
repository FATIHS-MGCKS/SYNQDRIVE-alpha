...
export function StationFormModal({ open, station, saving, orgId, onClose, onSubmit }: Props) {
  ...
  const sectionClass = 'surface-premium p-4 space-y-3';

  return (
    <div className="fixed inset-0 z-[80] flex items-end sm:items-center justify-center p-0 sm:p-4">
      <button type="button" className="absolute inset-0 bg-black/40" onClick={onClose} aria-label="Close" />
      <div className="relative w-full max-w-3xl max-h-[92vh] overflow-hidden rounded-t-dialog sm:rounded-dialog bg-background border border-border shadow-xl flex flex-col">
