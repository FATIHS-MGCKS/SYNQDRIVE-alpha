...
export const EXTRACTION_TEMPLATES: Record<string, FieldTemplate[]> = {
  ...
  FINE: [
    ...
    { key: 'noticeType', label: 'Bescheidtyp' },
    { key: 'offenseDateTime', label: 'Tatzeit', fieldType: 'datetime' },
    { key: 'eventDate', label: 'Datum', fieldType: 'date' },
    { key: 'eventTime', label: 'Uhrzeit' },
    { key: 'dueDate', label: 'Zahlungsfrist', fieldType: 'date' },
    { key: 'responseDeadline', label: 'Antwortfrist', fieldType: 'date' },
    { key: 'offenseType', label: 'Art des Verstoßes' },
    { key: 'offenseDescription', label: 'Verstoßbeschreibung', fieldType: 'multiline' },
    { key: 'location', label: 'Ort' },
    { key: 'issuingAuthority', label: 'Ausstellende Behörde / Firma' },
    { key: 'referenceNumber', label: 'Aktenzeichen' },
    ...
    { key: 'amountCents', label: 'Betrag', fieldType: 'currency' },
    { key: 'totalCents', label: 'Betrag (Legacy)', fieldType: 'currency' },
    { key: 'reportNumber', label: 'Aktenzeichen (Legacy)' },
  ],
  OTHER: [
    { key: 'eventDate', label: 'Datum' },
    { key: 'description', label: 'Beschreibung' },
