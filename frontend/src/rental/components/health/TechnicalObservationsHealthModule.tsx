        ...
        createPortal(
          ...
          >
            ...
            <div
              ...
              className="relative w-full sm:max-w-3xl max-h-[92vh] sm:max-h-[88vh] overflow-y-auto rounded-t-dialog sm: p-4 sm:p-5 surface-premium pb-[max(1.25rem,calc(env(safe-area-inset-bottom)+0.75rem))] transition-all duration-500 ease-out"
              style={{
