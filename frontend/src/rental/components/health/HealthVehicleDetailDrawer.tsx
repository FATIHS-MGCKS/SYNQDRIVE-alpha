...
export function HealthVehicleDetailDrawer({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="right"
        className="w-full gap-0 surface-premium p-0 sm:max-w-xl md:max-w-2xl max-sm:inset-x-0 max-sm:bottom-0 max-sm:top-auto max-sm:h-[92vh] max-sm:rounded-t-dialog max-sm:border-t"
      >
