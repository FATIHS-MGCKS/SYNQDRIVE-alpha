...
| **3 — Pattern adoption** | `DataCard` / `MetricCard` / `ControlKpiStrip` → `.surface-premium` / `.surface-elevated` | ✅ V4.9.276 |
...
*V4.9.276 — Phase 3 pattern adoption (DataCard, MetricCard, ControlKpiStrip).*
