...
const testFiles = [
  ...
  'src/rental/components/rental-invoice-detail-secondary-localization.test.tsx',
  ...
  'src/rental/components/rental-micro-chrome-localization.test.tsx',
  ...
  'src/operator/components/operator-booking-detail-localization.test.tsx',
...
const presentTestFiles = testFiles.filter((relPath) =>
  existsSync(join(frontendRoot, relPath)),
);

const result = spawnSync('npx', ['vitest', 'run', ...presentTestFiles], {
  cwd: frontendRoot,
  stdio: 'inherit',
  shell: false,
});
